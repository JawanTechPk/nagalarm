...
import redBtn from '../../assets/icons/redbtn.png'
const audioRecorderPlayer = new AudioRecorderPlayer();

const StartRecording = ({ navigation, route,closedRecord }) => {
...
// console.log(closedRecord,'closedRecord')
...
closedRecord(false)
  ...
  return (
    <SafeAreaView style={{ flex: 1, marginTop:-40,justifyContent: 'space-between' }}>
      <View>
            ...
            <View style={styles.centeredView}>
              <View style={styles.modalView}>
                ...
                <View style={{ flexDirection: 'row' }}>
                  <Pressable onPress={() => {onStopRecord();setModalVisible(false);closedRecord(false)}} style={{ height: 40, borderBottomLeftRadius: 20, flex: 1, backgroundColor: '#1E90FF', justifyContent: 'center' }}><Text style={{ fontSize: 22, textAlign: 'center', color: 'white', }}>CANCEL</Text></Pressable>
